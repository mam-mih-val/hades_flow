...
echo "executing $build_dir/correct list.txt /lustre/nyx/hades/user/mmamaev/hades_flow/src/param/efficiency.root"
$build_dir/correct list.txt /lustre/nyx/hades/user/mmamaev/hades_flow/src/param/efficiency.root
